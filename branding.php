...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['comment'])) {
    ...
    $insert_comment_sql = $conn->prepare("INSERT INTO comments_4 (comment, created_at) VALUES (?, NOW())");
...
<div class="categories-container">
  ...
  <div class="button-container">
    ...
    <a href="branding.php"><button class="filter-button active" data-category="BRANDING">BRANDING</button></a>
  </div>

  <div class="introduction">
    <h1>Welcome to Branding</h1>
    <h4>Crafting Unique Identities, Building Lasting Impressions: Elevate Your Brand with Creative Excellence and Strategic Insight</h4>
  </div>
  <div class="contents">
    <h2>Contents</h2>
  </div>
  ...
  <div class="cards-container" id="cards-container">
    <?php
      ...
      while ($row = $result->fetch_assoc()) {
        ...
        <div class="card">
          <div class="image-box">
            <img src="image/branding.jpg" alt="Article Image">
          </div>
  ...
  <div class="comments-container">
    ...
    <div id="comments-section">
      <?php
          ...
          $comments_sql = $conn->prepare("SELECT comment, created_at FROM comments_4 ORDER BY created_at DESC");
