...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['comment'])) {
    ...
    $insert_comment_sql = $conn->prepare("INSERT INTO comments_3 (comment, created_at) VALUES (?, NOW())");
...
<div class="categories-container">
  ...
  <div class="button-container">
    ...
    <a href="marketing_trends.php"><button class="filter-button active" data-category="MARKETING TRENDS">MARKETING TRENDS</button></a>
  ...
  <div class="introduction">
    <h1>Welcome to Marketing Trends</h1>
  ...
  <div class="comments-container">
    ...
    <div id="comments-section">
      <?php
          ...
          $comments_sql = $conn->prepare("SELECT comment, created_at FROM comments_3 ORDER BY created_at DESC");
